        ...
        <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "20px", padding: "32px" }}>
          ...
          <div style={{ display: "flex", background: "rgba(255,255,255,0.05)", borderRadius: "10px", padding: "4px", marginBottom: "24px" }}>
            <button
              ...
              style={{ flex: 1, padding: "8px", borderRadius: "8px", border: "none", cursor: "pointer", fontWeight: "500", fontSize: "14px", background: !isRegister ? "#7c3aed" : "transparent", color: !isRegister ? "white" : "rgba(255,255,255,0.4)", transition: "all 0.2s" }}
            >Login</button>
            <button
